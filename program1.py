...
def main():
   lingkaran3 = Lingkaran4(3.14, 8, 7)
   
   print('Objek lingkaran3')
   print('phi1\t: ', lingkaran3.phi1)
   print('jari2 1\t: ', lingkaran3.jari21)
   print('jari2 2\t: ', lingkaran3.jari22)
   print('LuasLingkaran\t= ', lingkaran3.hitungLuasLingkaran ())
   
   lingkaran5 = Lingkaran4(3.14, 9, 8)
   
   print('Objek lingkaran5')
   print('phi1\t: ', lingkaran5.phi1)
   print('jari2 1\t: ', lingkaran5.jari21)
   print('jari2 2\t: ', lingkaran5.jari22)
